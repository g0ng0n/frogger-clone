    ...
    function checkCollisions() {
        ...
        game.allEnemies.forEach(function(enemy) {
            ...
            if (enemy.y === game.player.y) {
                if (game.player.x < enemy.x + 83 && game.player.x + 83 > enemy.x) {
                    // If the player is carrying an item, drop it.
                    if (game.player.hasStar) {
                        game.star.drop();
                    }
                    game.player.liveLost();
        ...
        if (game.player.y === game.star.y && game.player.x === game.star.x) {
            if (game.player.hasStar === false) {
                game.player.pickup();
            }
        }
    }
